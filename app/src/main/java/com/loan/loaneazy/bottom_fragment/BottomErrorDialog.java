...
public class BottomErrorDialog extends BottomSheetDialogFragment implements View.OnClickListener {
    private BottomSheetBehavior mBehaviour;
    private MyButton btnCommonClose;
    private MyTextView tvCommonContent;
    CommonErrorListener mErrorCommonListener;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View mView = View.inflate(getActivity(), R.layout.dialog_error_bottom, null);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btnCommonCloseError) {
            mErrorCommonListener.onRequestError();
        }
    }

    private void findIds(View mView) {
        tvHeadTitle = (MyTextView) mView.findViewById(R.id.tvHeadTitleError);
        tvCommonContent = (MyTextView) mView.findViewById(R.id.tvCommonContentError);
        btnCommonClose = (MyButton) mView.findViewById(R.id.btnCommonCloseError);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        mErrorCommonListener = (CommonErrorListener) context;

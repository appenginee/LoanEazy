...
public class BottomProgressDialog extends BottomSheetDialogFragment implements View.OnClickListener {

    private MyTextView progress_text,tvTitleHead;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View mView = View.inflate(getActivity(), R.layout.dialog_bottom_progres, null);
    ...
    private void findIds(View mView) {
        ...
        progress_text = (MyTextView) mView.findViewById(R.id.progress_text);
        tvTitleHead = (MyTextView) mView.findViewById(R.id.tvTitleHead);
    ...
    public void updateProgress(int totalpercent) {
        progressBar.setProgress(totalpercent);
        progress_text.setText("Progress " + totalpercent + "%");
    }
    ...
    public void setTitle(String text) {
        tvTitleHead.setText("Please wait..uploading your "+text);
    }
}
